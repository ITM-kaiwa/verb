...
const SOURCE_OPTIONS: { value: DataSourceSetting; label: string }[] = [
  { value: "both", label: "Cả hai (Minna no Nihongo + Irodori)" },
  { value: "minna", label: "Chỉ Minna no Nihongo" },
  { value: "irodori", label: "Chỉ Irodori" },
];
    ...
    >
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          <h2 className="font-kyokasho text-xl text-kanjibrown">Cài đặt</h2>
          <button
            type="button"
            onClick={onClose}
            aria-label="Đóng"
        ...
        <div className="space-y-5 text-sm text-sand-700">
          <div>
            <p className="mb-2 font-semibold text-sand-700">Phạm vi dữ liệu động từ</p>
